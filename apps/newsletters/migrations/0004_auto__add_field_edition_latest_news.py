...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Edition.latest_news'
        db.add_column('newsletters_edition', 'latest_news',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Edition.latest_news'
        db.delete_column('newsletters_edition', 'latest_news_id')
    ...
    models = {
        ...
        'newsletters.edition': {
            ...
            'publish_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 4, 0, 0)'}),
