...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Edition.publish_on'
        db.alter_column('newsletters_edition', 'publish_on', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Edition.publish_on'
        db.alter_column('newsletters_edition', 'publish_on', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'newsletters.edition': {
            ...
            'publish_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 1, 0, 0)'}),
